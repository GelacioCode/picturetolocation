...
// [code, name, lat, lng] — ISO 3166-1 alpha-2, approximate centroid
const RAW: [string, string, number, number][] = [
  ...
  ['VC', 'Saint Vincent and the Grenadines', 13.25, -61.20],
...
export const COUNTRIES: CountryInfo[] = RAW.map(([code, name, lat, lng]) => ({
  code, name, lat, lng,
}))
